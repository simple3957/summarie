...
export default function HeroSection() {
    return (
        ...
        py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
                ...
                <h1 className=" sm:text-2xl lg:text-4xl text-center font-bold py-6 mb-4 ">Transform PDFs into concise summaries</h1>
                <h2 className="text-lg sm:text-xl lg:text-2xl text-center px-4
                lg:px-0 lg:max-w-4xl text-grey-600">Get a beautiful summary reel of the document in seconds.</h2>
                <div>
                    <Button variant={"link"} className="mt-6 text-base rounded-full text-white sm:text-lg lg:text-xl
