        ...
        lg:px-8 lg:pt-12">
            ...
            justify-center space-y-4 ">
                <div className="space-y-2">
                    ...
                    sm:text-3xl md:text-4xl ">Ready to Save hours of Reading Time?</h2>
                    <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed 
                    lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">Transform lengthy documents into clear, actionable insights with our AI-powered summarizer.</p>
                </div>
