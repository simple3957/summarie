...
const steps: Step[] = [
  {
    ...
    description:
      "Upload your PDF file to our platform and we'll take care of the rest.",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description:
      " Our AI will analyze the content of your PDF and generate a summary.",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    description:
      "Receive a clear summary of the key points of your PDF in a matter of seconds.",
  },
];
    ...
    <section className="relative overflow-hidden bg-gray-50">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <div className="text-center mb-16">
          ...
          <Link
            href="#pricing"
            className="mt-6 inline-block px-6 py-3 bg-rose-500 text-white font-bold rounded-lg shadow-md hover:bg-rose-600 transition-colors"
          >
            View Pricing
          </Link>
        </div>
